...
def PTG(start_s, start_d, target_vehicle, delta, T, predictions):
    ...
    arguments:
     ...
     delta - [s_FINAL, s_dot_FINAL, s_ddot_FINAL, d_FINAL, d_dot_FINAL, d_ddot_FINAL] 
       a length 6 array indicating the offset we are aiming for between us
