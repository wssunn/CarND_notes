"""
State: (x, y, theta, g, f) 
        An object which stores x, y coordinates, 
        direction theta, and current g and f values
...
NUM_THETA_CELLS:    The number of cells a circle is divided into.
                    Orientation for the vehicle (orientation, x, y) for 3D grid cell
...
def expand(state, goal):
    next_states = []
    for delta in range(-35, 40, 5): #steering angle, between [-35, 35]
