...
int main()
{
    ...
    // initialize priors, belief of position before movement
    vector<float> priors = initialize_priors(map_size, landmark_positions,
                                             position_stdev);


    float control_stdev = 1.0f;         // set standard deviation of control:
    float movement_per_timestep = 1.0f; // meters vehicle moves per time step
